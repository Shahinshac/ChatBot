...
export const metadata: Metadata = {
  title: "AetherAI | Intelligence, Refined.",
  description: "The next generation of conversational AI for modern teams. Secure, hyper-intelligent, and built for complex professional workflows.",
};
